...
# This is for all-in-one version of resume and job data, where all fields are concatenated in text_resume/text_job for simplicity
# This is the same as use encode_all=True with split fields
