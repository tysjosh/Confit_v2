...
def configure_test_data(args):
    if args.dset == 'recruiting_data':
        test_args = EmbeddingNetworkTestArguments(
            ...
            resume_data_path='dataset/recruiting_data/all_resume.csv',
...
if __name__ == '__main__':
    ...
    # model_checkpoints/openai/recruiting_data/all_resume_test_embeddings.jsonl
    # model_checkpoints/bert-base-multilingual-cased/recruiting_data/all_resume_test_embeddings.jsonl
    # model_checkpoints/multilingual-e5-large/aliyun/all_resume_test_embeddings.jsonl
    # model_checkpoints/multilingual-e5-large/recruiting_data/all_resume_test_embeddings.jsonl
    ...
    parser.add_argument(
        ...
        default='model_checkpoints/openai/recruiting_data',
    )
